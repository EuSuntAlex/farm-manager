package com.manager.farm.pages.evenimentPage.queryDto;
...
public interface EvenimentRepository extends CrudRepository<Eveniment, Long> {
    ...
    // NOU: Găsește evenimente pentru o bovină specifică
    List<Eveniment> findByUserIdAndBovinaId(Integer userId, Long bovinaId);
